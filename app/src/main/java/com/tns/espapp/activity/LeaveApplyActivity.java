...
public class LeaveApplyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().add(R.id.li_leave_apply,new LeaveApplyFragment_new()).commit();
        }
       // getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        webView.loadUrl("http://tnserp.com/ESP/LeaveForm/LeaveAplyWebView/" + empId);
    }
