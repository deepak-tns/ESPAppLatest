...
public class EntitlementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().add(R.id.li_entitlementinfo,new EntitlementInfoFragment_new()).commit();
        }
       // getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        webView.loadUrl("http://tnserp.com/ESP/Info/EntitlementInfoWebView/" + empId);
    }
