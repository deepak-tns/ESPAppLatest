...
public class LeaveSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().add(R.id.li_leave_summary,new LeaveSummaryFragment_new()).commit();
        }
      //  getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        webView.loadUrl("http://tnserp.com/esp/info/LeaveSummaryWebView/" + empId);
    }
