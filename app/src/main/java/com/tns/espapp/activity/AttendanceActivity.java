...
public class AttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().add(R.id.li_attandence,new AttendenceFragment_new()).commit();
        }
    //    getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent,
                ...
                dm.enqueue(request);
                Toast.makeText(AttendanceActivity.this, "Downloading File",Toast.LENGTH_LONG).show();
            }
        });
        ...
        webView.loadUrl("http://tnserp.com/ESP/Info/AttendenceInfoWebView/" + empId);
