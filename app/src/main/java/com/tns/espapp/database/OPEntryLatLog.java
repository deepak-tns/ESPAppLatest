...
/**
 * Created by TNS on 02-Feb-18.
 */

public class OPEntryLatLog {
    private   int id ;
    ...
    public  OPEntryLatLog(){

    }

    public OPEntryLatLog(String formno, String date, String lat, String longi, int latlong_flag, String totaldis, String current_time_str, String speed) {
        this.formno = formno;
        this.date = date;
        this.lat = lat;
        this.longi = longi;
