    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
       ...
       notificationCounter = sharedPreferences.getInteger(AppConstraint.NOTIFICATIONCOUNTER);
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            handleDataNotification(remoteMessage.getData().get("body"));
            db.add_DB_Notification(new NotificationData(remoteMessage.getData().get("title"), remoteMessage.getData().get("body"), currentDateTimeString, 0));
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            db.add_DB_Notification(new NotificationData(remoteMessage.getNotification().getBody(), remoteMessage.getNotification().getBody(), currentDateTimeString, 0));
