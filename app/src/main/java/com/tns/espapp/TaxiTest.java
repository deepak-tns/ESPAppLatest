...
public class TaxiTest extends AppCompatActivity implements LocationListener {
   ...
   NMEAParse nmeaParse = new NMEAParse();
    Button btn_start, btn_stop;
     private  double prelat , prelong, predistence,predistence2,predistence3,totaldistance,   spredistence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_live_taxi);
    ...
    private void findIDS() {
        ...
        ed_total_distence2 = (EditText) findViewById(R.id.edt_total_distance2);
        ed_total_distence3 = (EditText) findViewById(R.id.edt_total_distance3);
...
if(locationManager != null) {
     predistence =0;
     spredistence =0;
    ed_idletime.getText().clear();
    ed_total_traveltime.getText().clear();
    ed_total_distence.getText().clear();
    edt_startime.getText().clear();
              ...
              //  Log.d("Nmea STTTString GPRMC",  rawNmea.toString());
               ...
               /* SpannableStringBuilder builder = new SpannableStringBuilder();
                ...
                ed_stoptime.setText(time);
                 ...
                 spredistence =round(predistence,3);
