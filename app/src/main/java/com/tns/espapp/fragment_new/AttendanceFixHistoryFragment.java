...
public class AttendanceFixHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_attendance_fix_history, container, false);
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, AppConstraint.ATTENDANCEREMOTE, JsonParameterSendServer(ad),
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                      ...
                      //  db.updateAttandenceFixStatus(ad.getId(),1);
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    //    db.updateAttandenceFixStatus(ad.getId(),0);
   ...
   /*     SimpleDateFormat dateFormat2 = new SimpleDateFormat("dd-MMM-yyyy");
        ...
        */
        try {
            ...
            jsonObject.put("RadialDistance", dataList.get(0).getRadialdistance());
